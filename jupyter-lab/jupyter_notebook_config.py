...
#  be determined reliably by the Jupiter notebook server (proxified or
...
#  Choices: any of ['sha384', 'sha256', 'sha512', 'blake2s', 'md5', 'sha3_384', 'sha3_512', 'sha3_224', 'sha224', 'sha1', 'blake2b', 'sha3_256']
#  Default: 'sha256'
